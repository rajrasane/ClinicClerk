          ...
          <div className="border-b">
            <nav className="flex sm:space-x-8 sm:px-6">
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm flex-1 sm:flex-none text-center ${activeTab === 'details'
              ...
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm flex-1 sm:flex-none text-center ${activeTab === 'visits'
                    ? 'border-blue-500 text-blue-600'
                    : 'border-transparent text-gray-500 hover:text-gray-700'
                  }`}
              >
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${patient.gender === 'M' ? 'bg-blue-100 text-blue-800' :
